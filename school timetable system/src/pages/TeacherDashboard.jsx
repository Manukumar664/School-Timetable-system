...
export default function TeacherDashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-950 text-white relative">
      ...
      <button
        className="md:hidden fixed top-4 left-4 z-50 bg-gray-900 px-3 py-2 rounded"
        onClick={() => setSidebarOpen(!sidebarOpen)}
      >
        ☰
      </button>

      {/* ✅ Sidebar responsive wrapper (sidebar code same) */}
      <div
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-4 md:p-6 overflow-auto">
          ...
          {/* ===== MANAGE STUDENT ===== */}
          {activePage === "manage-student" && (
            <section className="bg-gray-900 p-4 md:p-6 rounded-2xl shadow-lg overflow-x-auto">
          ...
          {activePage === "view-timetable" && (
            <section className="space-y-6">
              ...
              <div className="bg-gray-900 p-4 md:p-6 rounded-xl">
                <h2 className="text-lg md:text-xl font-bold mb-4 text-cyan-400">
                  Unassigned Classes
                </h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {unassignedClasses.map((cls) => (
                    <div
                      key={cls._id}
                      className="p-4 bg-gray-950 rounded-lg border"
                    >
